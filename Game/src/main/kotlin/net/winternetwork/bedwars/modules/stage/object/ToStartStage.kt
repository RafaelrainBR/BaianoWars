...
class ToStartStage(
        stageModule: _root_ide_package_.net.winternetwork.bedwars.modules.stage.StageModule,
        mapModule: _root_ide_package_.net.winternetwork.bedwars.modules.maps.MapModule
) : Stage("Starting", 20) {
